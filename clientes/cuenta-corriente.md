---
description: >-
  Controlá y consultá el saldo de cuenta corriente de los clientes. Incluye las
  reglas importantes sobre bloqueos y plazos de pago.
---
...
:red\_circle: **Bloqueos por Deuda:** No se desbloqueará a clientes que **NO** tengan cuenta corriente asignada y posean deuda.

***

:red\_circle: **Clientes sin Cta. Cte:** El pago máximo debe ser a **7 días**.
...
:yellow\_circle: **Apertura de Cuentas:** Si el cliente es habitual o realiza compras recurrentes, deben solicitar la apertura de su cuenta corriente enviando un mensaje al **celu de cobranzas (Nadia)**.

***

:yellow\_circle:**Recurso Código 999.999:** Que viene por Default y se utiliza exclusivamente para:
...
*   **Consulta Rápida**
    ...
    Desde este ítem podemos ver la consulta rápida de la cuenta corriente del cliente en toda la empresa.
...
*   Vamos a ir desde Ventas - Clientes - Cuentas Corrientes - Consultas - CTA CTE PROPIA.

    ![image.png](../.gitbook/assets/Cuenta_Corriente__image_3.png)

{% hint style="warning" icon="lightbulb-exclamation" %}
