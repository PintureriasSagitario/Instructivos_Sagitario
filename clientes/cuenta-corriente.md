...
*   **Consulta de Cuenta Corriente**
    ...
    * Y este es el reporte que genera, y podemos imprimirlo si es necesario. **DEBE:** Indica la deuda del cliente (facturas pendientes). **HABER:** Indica saldos a favor (notas de crédito o pagos adelantados).
