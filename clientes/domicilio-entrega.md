...
Cuando el cliente necesita que el pedido se le entregue tenemos que agregar la dirección de entrega con todos los datos necesarios para que los chicos que reparten puedan encontrar el lugar sin problemas, contactarse con el cliente por si pasa algo y demas. 

👉🏽 Vamos a ir desde Ventas - Clientes - Domicilios de entrega - Ingresar domicilio

![image.png](../.gitbook/assets/Domicilio_de_entrega__image.png)
...
![image.png](../.gitbook/assets/Domicilio_de_entrega__image_1.png)
...
3. Si o si hay que agreguemos Cod_pro_ib. Si es provincia ponemos 1. Si es capital ponemos 2.  Sino con F6 seleccionamos el que necesitamos. 

![image.png](../.gitbook/assets/Domicilio_de_entrega__image_2.png)
