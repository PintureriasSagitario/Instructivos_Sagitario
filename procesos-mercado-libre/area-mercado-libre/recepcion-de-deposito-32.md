---
description: >-
  Para los productos de ventas de Mercado Libre que se despacharon desde otras
  sucursales.
---

# Recepción de Depósito 32

#### ¿Para qué sirve?

Cuando una venta de Mercado Libre se despacha desde **otra sucursal**, esa sucursal transfiere la mercadería al **Depósito 32**. Acá se recepciona esa transferencia para que el stock quede correcto.

> ⚠️ **No confundir con la transferencia diaria del despacho.** La transferencia que hace Andrea del Dep 28 al Dep 32 **no se recepciona**. Esta recepción es solo para lo que llega transferido desde otras sucursales.

***

## Paso a paso

#### 1 · Entrar a la pantalla de recepción
...
Se completa la columna **Recepción** con lo que efectivamente llegó.
...
Una vez que se tomó todo, dar **ESC**.

***

## Los dos carteles

Acá hay que prestar atención, porque el cartel que aparece depende de si las cantidades coinciden.
...
> ⚠️ **Este cartel es un aviso, no un error.** Puede ser que se cargó mal, o puede ser que realmente se transfirió algo erroneo o difiere cantidad. Antes de avanzar hay que saber cuál de las dos es.
